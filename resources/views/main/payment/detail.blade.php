    ...
    <svg
      ...
      <path
          ...
          clip-rule="evenodd"/>
                        ...
                        <form id="updateForm" action="{{ route('payment.update', ['id' => $payment->id]) }}"
                              method="POST">
                            @csrf
                            <div
                        ...
                        <form id="restoreForm" action="{{ route('payment.restore', ['id' => $payment->id]) }}"
                              method="GET">@csrf</form>
                        <form id="softDeleteForm" action="{{ route('payment.softDelete', ['id' => $payment->id]) }}"
                              method="GET">@csrf</form>
                        <form id="deleteForm" action="{{ route('payment.delete', ['id' => $payment->id]) }}"
                              method="GET">@csrf</form>
                    </div>
