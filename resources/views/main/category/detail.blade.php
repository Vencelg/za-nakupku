            ...
            <div class="mx-auto w-full">
                <div class="w-full h-full" style="">
                    ...
                    <div class="px-12 pt-6">
                        @if(session('success'))
                            <div
                                class="mb-3 inline-flex w-full items-center rounded-lg bg-green-400/30 py-5 px-6
                                text-base
                                text-green-600"
                                role="alert">
  <span class="mr-2">
    <svg
      ...
      <path
          ...
          clip-rule="evenodd"/>
                        ...
                        <form id="updateForm" action="{{ route('category.update', ['id' => $category->id]) }}"
                              method="POST">
                            @csrf
                            <div
                            ...
                            <div class="mb-3 pb-2 w-full">
                                <select name="icon" data-te-select-init data-te-select-filter="true" class="w-full">
                        ...
                        <form id="restoreForm" action="{{ route('category.restore', ['id' => $category->id]) }}"
                              method="GET">@csrf</form>
                        <form id="softDeleteForm" action="{{ route('category.softDelete', ['id' => $category->id]) }}"
                              method="GET">@csrf</form>
